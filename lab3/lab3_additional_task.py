...
class Window:
    def __init__(self, flag=0):
        ...
        self.b0 = ((np.linalg.det(np.array([[self.my, self.mx1, self.mx2, self.mx3],
                                            [self.a1, self.a11, self.a12, self.a13],
                                            [self.a2, self.a12, self.a22, self.a32],
                                            [self.a3, self.a13, self.a23, self.a33]]))) /
                   ((np.linalg.det(np.array([[1, self.mx1, self.mx2, self.mx3],
                                             [self.mx1, self.a11, self.a12, self.a13],
                                             [self.mx2, self.a12, self.a22, self.a32],
        ...
        self.b1 = ((np.linalg.det(np.array([[1, self.my, self.mx2, self.mx3], [self.mx1, self.a1, self.a12, self.a13],
                                            [self.mx2, self.a2, self.a22, self.a32],
                                            [self.mx3, self.a3, self.a23, self.a33]]))) /
                   ((np.linalg.det(np.array( [[1, self.mx1, self.mx2, self.mx3],
                                              [self.mx1, self.a11, self.a12, self.a13],
                                              [self.mx2, self.a12, self.a22, self.a32],
                                              [self.mx3, self.a13, self.a23, self.a33]])))))
        self.b2 = ((np.linalg.det(np.array([[1, self.mx1, self.my, self.mx3], [self.mx1, self.a11, self.a1, self.a13],
                                            [self.mx2, self.a12, self.a2, self.a32],
                                            [self.mx3, self.a13, self.a3, self.a33]]))) /
                   ((np.linalg.det(np.array( [[1, self.mx1, self.mx2, self.mx3],
                                              [self.mx1, self.a11, self.a12, self.a13],
                                              [self.mx2, self.a12, self.a22, self.a32],
                                              [self.mx3, self.a13, self.a23, self.a33]])))))
        self.b3 = ((np.linalg.det(np.array([[1, self.mx1, self.mx2, self.my],
                                            ...
                                            [self.mx2, self.a12, self.a22, self.a2],
                                            [self.mx3, self.a13, self.a23, self.a3]]))) /
                   ((np.linalg.det(np.array( [[1, self.mx1, self.mx2, self.mx3],
                                              [self.mx1, self.a11, self.a12, self.a13],
                                              [self.mx2, self.a12, self.a22, self.a32],
                                              [self.mx3, self.a13, self.a23, self.a33]])))))
